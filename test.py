...
class EditorVideoCompleto:
    ...
    def crear_pestana_multiple_texto(self):
        ...
        tk.Label(self.texto_actual_frame, text="Texto:").grid(row=0, column=0, sticky='w')
        self.multiple_texto = tk.Entry(self.texto_actual_frame, width=50)
        self.multiple_texto.grid(row=0, column=1, padx=5, pady=2)
        
        tk.Label(self.texto_actual_frame, text="Inicio (seg):").grid(row=1, column=0, sticky='w')
        self.multiple_inicio = tk.Entry(self.texto_actual_frame, width=10)
        self.multiple_inicio.grid(row=1, column=1, sticky='w', padx=5, pady=2)
        self.multiple_inicio.insert(0, "0")
        
        tk.Label(self.texto_actual_frame, text="Duración (seg):").grid(row=2, column=0, sticky='w')
        self.multiple_duracion = tk.Entry(self.texto_actual_frame, width=10)
        self.multiple_duracion.grid(row=2, column=1, sticky='w', padx=5, pady=2)
        self.multiple_duracion.insert(0, "5")
